...
var t = { color: 'blue', material: 'purecotton', design: 'v neck', size: 's' };
var t1 = { color: 'blue', material: 'purecotton', design: 'v neck', size: 'M' };
var t2 = { color: 'blue', material: 'purecotton', design: 'v neck', size: 'XL' };
